...
public class Project {
    ...
    static {
        ...
        employees.put("5", new Employee("5", "Jane", "Smith", "1995-05-15", 20.0, 90000));
        employees.put("6", new Employee("6", "David", "Johnson", "1988-09-30", 18.0, 90000));
        employees.put("7", new Employee("7", "John", "Doe", "1990-01-01", 15.0, 90000));
        employees.put("8", new Employee("8", "Jane", "Smith", "1995-05-15", 20.0, 90000));
        employees.put("9", new Employee("9", "David", "Johnson", "1988-09-30", 18.0, 90000));
        employees.put("10", new Employee("10", "John", "Doe", "1990-01-01", 15.0, 90000));
        employees.put("11", new Employee("11", "Jane", "Smith", "1995-05-15", 20.0, 90000));
        employees.put("12", new Employee("12", "David", "Johnson", "1988-09-30", 18.0, 90000));
        employees.put("13", new Employee("13", "John", "Doe", "1990-01-01", 15.0, 90000));
        employees.put("14", new Employee("14", "Jane", "Smith", "1995-05-15", 20.0, 90000));
        employees.put("15", new Employee("15", "David", "Johnson", "1988-09-30", 18.0, 90000));
        employees.put("16", new Employee("16", "John", "Doe", "1990-01-01", 15.0, 90000));
        employees.put("17", new Employee("17", "Jane", "Smith", "1995-05-15", 20.0, 90000));
        employees.put("18", new Employee("18", "David", "Johnson", "1988-09-30", 18.0, 90000));
        employees.put("19", new Employee("19", "Jane", "Smith", "1995-05-15", 20.0, 90000));
        employees.put("20", new Employee("20", "David", "Johnson", "1988-09-30", 18.0, 90000));
        employees.put("21", new Employee("21", "John", "Doe", "1990-01-01", 15.0, 90000));
        employees.put("22", new Employee("22", "Jane", "Smith", "1995-05-15", 20.0, 90000));
        employees.put("23", new Employee("23", "David", "Johnson", "1988-09-30", 18.0, 90000));
        employees.put("24", new Employee("24", "John", "Doe", "1990-01-01", 15.0, 90000));
        employees.put("25", new Employee("25", "Jane", "Smith", "1995-05-15", 20.0, 90000));
        employees.put("26", new Employee("26", "David", "Johnson", "1988-09-30", 18.0, 90000));
        employees.put("27", new Employee("27", "John", "Doe", "1990-01-01", 15.0, 90000));
        employees.put("28", new Employee("28", "Jane", "Smith", "1995-05-15", 20.0, 90000));
        employees.put("29", new Employee("29", "David", "Johnson", "1988-09-30", 18.0, 90000));
        employees.put("30", new Employee("30", "John", "Doe", "1990-01-01", 15.0, 90000));
        employees.put("31", new Employee("31", "John", "Doe", "1990-01-01", 15.0, 90000));
        employees.put("32", new Employee("32", "Jane", "Smith", "1995-05-15", 20.0, 90000));
        employees.put("33", new Employee("33", "David", "Johnson", "1988-09-30", 18.0, 90000));
        employees.put("34", new Employee("34", "John", "Doe", "1990-01-01", 15.0, 90000));
    }
    // Welcome 
